...
def push_tape(tape):
    ...
    # pywrap_tensorflow.TFE_Py_TapeSetAdd(tape._tape)  # pylint:
...
def pop_tape(tape):
    ...
    # pywrap_tensorflow.TFE_Py_TapeSetRemove(tape._tape)  # pylint:
    # disable=protected-access
    pass
...
def record_operation(op_type, output_tensors,
