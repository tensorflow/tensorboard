...
(function (vz_sorting) {
    describe('compareTagNames', () => {
        ...
        const sortTagNames = (a) => a.sort(vz_sorting.compareTagNames);
        it('is asciibetical', () => {
        ...
        it('sorts engineering notation', () => {
            ...
            assert.deepEqual(sortTagNames(['a1.0e9', 'a9.0e8']), [
                'a9.0e8',
                'a1.0e9',
            ]);
            assert.deepEqual(sortTagNames(['a1.0e+9', 'a9.0e+8']), [
                'a9.0e+8',
                'a1.0e+9',
            ]);
        });
        it('is componentized by slash', () => {
            ...
            assert.deepEqual(sortTagNames(['a+/a', 'a/a', 'ab/a']), [
                'a/a',
                'a+/a',
                'ab/a',
            ]);
        ...
        it('is componentized by underscore', () => {
            assert.deepEqual(sortTagNames(['a+_a', 'a_a', 'ab_a']), [
                'a_a',
                'a+_a',
                'ab_a',
            ]);
            assert.deepEqual(sortTagNames(['a+/a', 'a_a', 'ab_a']), [
                'a_a',
                'a+/a',
                'ab_a',
            ]);
        ...
        it('is componentized by number boundaries', () => {
            assert.deepEqual(sortTagNames(['a+0a', 'a0a', 'ab0a']), [
                'a0a',
                'a+0a',
                'ab0a',
            ]);
        ...
        it('empty comes first', () => {
            assert.deepEqual(sortTagNames(['a', '//', '/', '']), [
                '',
                '/',
                '//',
                'a',
