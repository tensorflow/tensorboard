...
export class PanZoomDragLayer extends Plottable.Components.Group {
  ...
  private _mouseDispatcher: Plottable.Dispatchers.Mouse | null = null;
  ...
  private onWheel(_: any, event: WheelEvent) {
  ...
  onScrollZoom(cb: Plottable.Interactions.ZoomCallback) {
    this.panZoom.onZoomEnd(cb);
  }
  onDragZoomStart(cb: Plottable.Interactions.ZoomCallback) {
    this.dragZoomLayer.interactionStart(cb);
  }
  onDragZoomEnd(cb: Plottable.Interactions.ZoomCallback) {
