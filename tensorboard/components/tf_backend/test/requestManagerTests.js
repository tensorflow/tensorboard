    ...
    describe('backend', () => {
        ...
        describe('request manager', () => {
            ...
            it('queue continues after failures', (done) => {
                ...
                r0.then((success) => done(new Error('r0 should have failed')), (failure) => 'unused_argument').then(() => rm.resolveFakeRequest());
            ...
            describe('fetch', () => {
                ...
                it('sends requests concurrently', function () {
                    return __awaiter(this, void 0, void 0, function* () {
                        this.stubbedFetch
                            .onCall(0)
                            .returns(this.resolvesAfter(new Response('nay', { status: 200 }), 3000));
                        this.stubbedFetch
                            .onCall(1)
