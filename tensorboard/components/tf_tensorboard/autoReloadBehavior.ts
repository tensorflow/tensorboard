...
export class AbstractAutoReloadBehavior extends LegacyElementMixin(
  PolymerElement
) {
  @property({
    type: Boolean,
  ...
  autoReloadEnabled = getAutoReloadFromLocalStorage();

  @property({
    type: Number,
  })
  _autoReloadId: number = 0;
  ...
  _autoReloadObserver(autoReload: boolean) {
