...
(function (tf_tensorboard) {
    const { expect } = chai;
    function checkSlottedUnderAncestor(element, ancestor) {
        ...
        window.HTMLImports.whenReady(() => {
            ...
            describe('custom path', () => {
                ...
                it('throws when homePath is one of bad wrong protocols', () => {
                    const expectedError1 = "Expect 'homePath' to be of http: or https:. " +
                        'javascript:alert("PWNED!")';
                    chai.assert.throws(() => {
                        tensorboard.homePath = 'javascript:alert("PWNED!")';
                    }, expectedError1);
                    const expectedError2 = "Expect 'homePath' to be of http: or https:. " +
                ...
                it('throws when homePath is not a path', () => {
                    const expectedError1 = "Expect 'homePath' be a path or have the same origin. " +
