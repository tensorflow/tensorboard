...
describe('Npmi Annotations List Container', () => {
  ...
  it('renders expanded annotations list', () => {
    ...
    const annotationsLegend = fixture.debugElement.query(By.css(css.LEGEND));
    expect(annotationsLegend).toBeTruthy();

    const annotationsHeader = fixture.debugElement.query(By.css(css.HEADER));
    expect(annotationsHeader).toBeTruthy();
  });
  ...
  it('renders non-expanded annotations list', () => {
    ...
    const annotationsLegend = fixture.debugElement.query(By.css(css.LEGEND));
    expect(annotationsLegend).toBeNull();

    const annotationsHeader = fixture.debugElement.query(By.css(css.HEADER));
    expect(annotationsHeader).toBeNull();
  });
});
