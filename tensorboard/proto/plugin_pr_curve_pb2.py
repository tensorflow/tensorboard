...
# source: tensorboard/proto/plugin_pr_curve.proto
...
PrCurvePluginData = _reflection.GeneratedProtocolMessageType('PrCurvePluginData', (_message.Message,), dict(
  ...
  __module__ = 'tensorboard.proto.plugin_pr_curve_pb2'
