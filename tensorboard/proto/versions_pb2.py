...
# source: tensorboard/proto/versions.proto
...
VersionDef = _reflection.GeneratedProtocolMessageType('VersionDef', (_message.Message,), dict(
  ...
  __module__ = 'tensorboard.proto.versions_pb2'
