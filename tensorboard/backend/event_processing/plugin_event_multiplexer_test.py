...
class EventMultiplexerTest(tf.test.TestCase):
    ...
    def testPluginRunToTagToContent(self):
        ...
        self.assertDictEqual(
            {
                "run1": {"path1_foo": "foo_content", "path1_bar": "bar_content",},
                "run2": {"path2_foo": "foo_content", "path2_bar": "bar_content",},
            },
    ...
    """
        ...
        self.assertEqual(x.GetAccumulator("path1"), loader1, "loader1 not regenerated")
    ...
    def testAddRunsFromDirectoryWalksTree(self):
        ...
        self.assertItemsEqual(
            x.Runs(), [".", "subdirectory/1", "subdirectory/2", "subdirectory/1/1"]
        )
