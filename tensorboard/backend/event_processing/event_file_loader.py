...
class EventFileLoader(object):
    ...
    def Load(self):
        ...
        Calling Load multiple times in a row will not 'drop' events as long
        as the return value is not iterated over.
        ...
        while True:
            try:
                ...
                # truncated. PyRecordReader holds the offset prior to the
                # failed read, so retrying will succeed.
                break
            event = tf.Event()
