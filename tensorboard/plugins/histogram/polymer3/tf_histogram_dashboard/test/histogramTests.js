...
(function (tf_histogram_dashboard) {
    describe('Verify that the histogram format conversion works.', () => {
        ...
        it('Handles data with one bin', () => {
            ...
            const actual = tf_histogram_dashboard.intermediateToD3({
                wall_time: 1234.5,
                step: 0,
                min: 1.1e-12,
                max: 1.21e-12,
        ...
        it('Handles a histogram of all zeros', () => {
            const h = {
                ...
                buckets: [
                    ...
                    { left: 1e-12, right: 1.7976931348623157e308, count: 0 },
                ],
            };
            const actual = tf_histogram_dashboard.intermediateToD3(h, 0, 0, 5);
            const expected = [
                { x: -1, dx: 0.4, y: 0 },
                { x: -0.6, dx: 0.4, y: 0 },
