        ...
        return (scalarChart, run, data) => {
            if (data.regex_valid) {
                ...
                _.forOwn(data.tag_to_events, (scalarEvents, tag) => {
                    ...
                    const seriesName = tf_custom_scalar_dashboard.generateDataSeriesName(run, tag);
                    ...
                    if (datum) {
                        ...
                        const series = new tf_custom_scalar_dashboard.DataSeries(run, tag, seriesName, data, lineChartSymbol);
