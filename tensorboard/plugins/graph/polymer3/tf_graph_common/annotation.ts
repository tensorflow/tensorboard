...
limitations under the License.
==============================================================================*/
export function buildGroup(container, annotationData: render.AnnotationList, d: render.RenderNodeInfo, sceneElement) {
...
function addInteraction(selection, d: render.RenderNodeInfo, annotation: render.Annotation, sceneElement) {
    selection
        .on("mouseover", (a) => {
