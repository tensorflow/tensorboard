 ...
 */
export function getSubtaskTracker(parentTracker: ProgressTracker, impactOnTotalProgress: number, subtaskMsg: string): ProgressTracker {
    return {
 ...
 */
export function runTask<T>(msg: string, incProgressValue: number, task: () => T, tracker: ProgressTracker): T {
 ...
 */
export function runAsyncTask<T>(msg: string, incProgressValue: number, task: () => T, tracker: ProgressTracker): Promise<T> {
 ...
 */
export function runAsyncPromiseTask<T>(msg: string, incProgressValue: number, task: () => Promise<T>, tracker: ProgressTracker): Promise<T> {
    return new Promise((resolve, reject) => {
 ...
 */
export function convertUnitsToHumanReadable(value: number, units: Units, unitIndex: number = 0) {
