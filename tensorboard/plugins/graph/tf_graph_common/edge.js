        ...
        (function (scene) {
            ...
            (function (edge) {
                ...
                edge.EDGE_WIDTH_SIZE_BASED_SCALE = d3.scalePow()
                    ...
                    .clamp(true);
                let arrowheadMap = d3.scaleQuantize().domain([edge.MIN_EDGE_WIDTH, edge.MAX_EDGE_WIDTH]).range([
                ...
                function buildGroup(sceneGroup, graph, sceneElement) {
                    ...
                    let container = scene.selectOrCreateChild(sceneGroup, 'g', scene.Class.Edge.CONTAINER);
                    // Select all children and join with data.
                    // (Note that all children of g.edges are g.edge)
                    let edgeGroups = container.selectAll(function () { return this.childNodes; }).data(edges, getEdgeKey);
                ...
                function getEdgePathInterpolator(component, renderPath, d, i, a) {
                    ...
                    let adjoiningPath = (adjoiningMetaedge.edgeGroup.node()
                        .firstChild);
                    ...
                    return function (t) {
                        ...
                        let dPath = edge.interpolate(points);
                        return dPath;
                    };
                }
                function position(component, edgeGroup) {
                    d3.select(edgeGroup)
