        ...
        (function (scene) {
            ...
            (function (node_1) {
                ...
                function buildGroup(sceneGroup, nodeData, sceneElement) {
                    ...
                    nodeGroups
                        ...
                        if (d.inAnnotations.list.length > 0) {
                            nodeGroup
                                .select('.' + scene.Class.Annotation.INBOX)
                        ...
                        if (d.outAnnotations.list.length > 0) {
                            nodeGroup
                                .select('.' + scene.Class.Annotation.OUTBOX)
                                .selectAll('.' + scene.Class.Annotation.GROUP)
                                .each((a) => {
                                sceneElement.removeAnnotationGroup(a, d);
                            });
                ...
                function addButton(selection, d, sceneElement) {
                    ...
                    scene
                        .selectOrCreateChild(group, 'path', scene.Class.Node.EXPAND_BUTTON)
                        .attr('d', 'M0,-2.2 V2.2 M-2.2,0 H2.2');
                    scene
                        .selectOrCreateChild(group, 'path', scene.Class.Node.COLLAPSE_BUTTON)
                        .attr('d', 'M-2.2,0 H2.2');
                    group.on('click', (d) => {
                ...
                function labelBuild(nodeGroup, renderNodeInfo, sceneElement) {
                    ...
                    let useFontScale = renderNodeInfo.node.type === graph.NodeType.META && !renderNodeInfo.expanded;
                ...
                function labelPosition(nodeGroup, cx, cy, yOffset) {
                    scene
                        .selectChild(nodeGroup, 'text', scene.Class.Node.LABEL)
                        .transition()
                        .attr('x', cx)
                        .attr('y', cy + yOffset);
                }
                ...
                function buildShape(nodeGroup, d, nodeClass) {
                    ...
                    switch (d.node.type) {
                        ...
                        case graph.NodeType.SERIES:
                            ...
                            scene
                                .selectOrCreateChild(shapeGroup, 'rect', scene.Class.Node.COLOR_TARGET)
                                .attr('rx', d.radius)
                                .attr('ry', d.radius);
                            break;
