        ...
        (function (render) {
            ...
            var RenderGraphInfo = /** @class */ (function () {
                    ...
                    _.each(libraryMetanode.metagraph.nodes(), function (nodeName) {
                        ...
                        switch (node.type) {
                            case graph_1.NodeType.META:
                                ...
                                var newNode = _this.cloneFunctionLibraryMetanode(metagraph, opNodeToReplace, node, oldPrefix, newPrefix);
                ...
                RenderGraphInfo.prototype.patchEdgesIntoFunctionInputs = function (opNodeToReplace, newOpNode) {
                    var inputIndex = newOpNode.functionInputIndex;
                    ...
                    var originalMetaEdge = originalMetaEdges.regular[newOpNode.functionInputIndex];
