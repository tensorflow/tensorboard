...
(function (tf) {
    ...
    (function (graph_1) {
        var op;
        (function (op) {
            var TpuCompatibilityProvider = /** @class */ (function () {
                function TpuCompatibilityProvider() {
                }
                /**
                 * Returns true if the node's inferred device is not the TPU.
                 * Note that this is only a best-effort check.
                 */
                TpuCompatibilityProvider.prototype.isNotTpuOp = function (opDevice) {
                ...
                TpuCompatibilityProvider.prototype.opValid = function (opNode) {
                ...
                return TpuCompatibilityProvider;
            }());
            op.TpuCompatibilityProvider = TpuCompatibilityProvider;
