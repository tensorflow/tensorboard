        ...
        (function (scene) {
            ...
            function position(sceneGroup, renderNode) {
                ...
                let yTranslate = renderNode.node.type === graph.NodeType.SERIES
                    ? 0
                    : graph.layout.PARAMS.subscene.meta.labelHeight;
                // core
                ...
                if (hasInExtract) {
                    ...
                    if (auxWidth < graph.layout.MIN_AUX_WIDTH) {
                        inExtractX =
                            inExtractX - graph.layout.MIN_AUX_WIDTH + renderNode.inExtractBox.width / 2;
                    }
                    else {
                        inExtractX =
                            inExtractX -
            ...
            function positionButton(button, renderNode) {
                ...
                button
                    .select('circle')
                    .transition()
                    .attr({ cx: x, cy: y, r: graph.layout.PARAMS.nodeSize.meta.expandButtonRadius });
            }
