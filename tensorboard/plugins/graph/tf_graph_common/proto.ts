...
interface TensorShape {
  dim: Array<{size: number; name: string}>;
  unknown_rank: boolean;
}

export interface NodeDefAttrValue {
  s?: string;
  i?: number;
  f?: number;
  b?: boolean;
  // refer to tensorboard/compat/proto/types.proto#DataType
  type?: string;
  shape?: TensorShape;
  // refer to tensorboard/compat/proto/tensor.proto#TensorProto
  tensor?: object;
  func?: object;
  placeholder?: string;
...
export type NodeDefAttr = {
  key: string;
  value: NodeDefAttrValue;
}[];
