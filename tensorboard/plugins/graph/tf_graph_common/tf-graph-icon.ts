...
import {MetanodeColors, SeriesNodeColors, OpNodeColors} from './render';
...
export class TfGraphIcon extends PolymerElement {
  ...
  getSvgDefinableElement(): SVGSVGElement {
    return this.$.svgDefs as SVGSVGElement;
  }
