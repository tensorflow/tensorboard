...
export class LinesCollection {
    public constructor(svgProps: SVGProperties, schema: tf.hparams.Schema, axesCollection: AxesCollection) {
     ...
     */
    public setForegroundLinesColor(colorByColumnIndex: number | null, minColor: string, maxColor: string) {
     ...
     * redraws the lines.
     */
    public redraw(sessionGroups: tf.hparams.SessionGroup[], colorByColumnIndex: number | null, minColor: string, maxColor: string) {
    ...
    public findClosestSessionGroup(x: number, y: number): SessionGroupHandle {
        const axesPositions = this._axesCollection.mapVisibleAxes<number>((xPosition, axis) => xPosition);
    ...
    private _createLineColorFunction(colorByColumnIndex: number | null, minColor: string, maxColor: string): (any) => string {
     ...
     * the axesCollection.
     */
    private _setControlPointsProperty(pathElement: any, sessionGroup: tf.hparams.SessionGroup) {
     ...
     */
    private _computeControlPoints(sessionGroup: tf.hparams.SessionGroup): [number, number][] {
        return this._axesCollection.mapVisibleAxes<[number, number]>((xPosition, axis) => [
            xPosition,
