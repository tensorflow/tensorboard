...
export class InteractionManager {
    public constructor(svgProps: SVGProperties, schema: tf.hparams.Schema, peakedSessionGroupChangedCallback: SessionGroupCallback, selectedSessionChangedCallback: SessionGroupCallback) {
    ...
    public onBrushChanged(colIndex: number, newBrushSelection: d3.BrushSelection) {
    ...
    public onOptionsOrSessionGroupsChanged(newOptions: any, newSessionGroups: any[]) {
