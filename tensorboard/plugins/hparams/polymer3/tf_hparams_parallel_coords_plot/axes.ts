...
class IntervalBrushFilter implements AxisBrushFilter {
     ...
     */
    public constructor(lower: number, upper: number, lowerOpen: boolean, upperOpen: boolean) {
        this._lower = lower;
        this._upper = upper;
...
export class Axis {
     ...
     */
    public constructor(svgProps: SVGProperties, schema: tf.hparams.Schema, interactionManager: InteractionManager, colIndex: number) {
     ...
     * scale.
     */
    private _buildBrushFilter(brushSelection: d3.BrushSelection, scaleType: ScaleType, yScale: any /* D3 scale */) {
...
export class AxesCollection {
    public constructor(svgProps: SVGProperties, schema: tf.hparams.Schema, interactionManager: InteractionManager) {
        this._svgProps = svgProps;
        this._schema = schema;
