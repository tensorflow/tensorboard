...
class TextPluginTest(tf.test.TestCase):
    ...
    def testSanitization(self):
        ...
        self.assertEqual(text_plugin.markdown_and_sanitize(dangerous),
                         sanitized)
    ...
    def test_reduce_to_2d(self):
        ...
        def make_range_array(dim):
            ...
            Returns:
                An array of increasing integer elements, with dim dimensions
                and size
    ...
    def test_text_array_to_html(self):
        ...
        warning = text_plugin.markdown_and_sanitize(
            text_plugin.WARNING_TEMPLATE %
            3)
