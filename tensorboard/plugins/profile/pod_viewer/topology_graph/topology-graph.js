...
(function (pod_viewer_topology_graph) {
    ...
    Polymer({
         ...
         */
        _computeTopoData: function (data, runEnvironment, metrics) {
        ...
        topologyGraph: function (data) {
            ...
            if (!this._gSVG) {
                this._gSVG = d3
                    ...
                    .attr('height', hostYDim * this._hostGridHeight + SVG_MARGIN.bottom + SVG_MARGIN.top)
                    .append('g')
        ...
        getChipXLoc: function (xHost, xChip) {
            return (xHost * this._hostGridWidth +
                HOST_TO_CHIP_MARGIN +
        ...
        getChipYLoc: function (yHost, yChip) {
            return (yHost * this._hostGridHeight +
                HOST_TO_CHIP_MARGIN +
        ...
        _getToolTipText: function (data) {
            const label = this.selectedMetricIdx >= 0
                ...
                : '';
            const value = this.selectedMetricIdx >= 0 ? data.values[this.selectedMetricIdx] : 0;
