...
==============================================================================*/
var pod_viewer_details_card;
(function (pod_viewer_details_card) {
    Polymer({
        is: 'details-card',
        properties: {
            nodes: {
         ...
         * recv-done operation.
         */
        _bandwidth: function (dataSize, duration) {
...
})(pod_viewer_details_card || (pod_viewer_details_card = {})); // namespace pod_viewer_details_card
