...
class TraceEventsJsonStream(object):
    ...
    Iterating over this yields a sequence of string chunks, so it is
    suitable for returning in a werkzeug Response.
    """
    ...
    def _event(self, event):
        """Converts a TraceEvent proto into a catapult trace event python
        value."""
        result = dict(
            pid=event.device_id,
