...
class InteractiveInferencePlugin(base_plugin.TBPlugin):
    ...
    def __init__(self, context):
        ...
        self._has_auth_group = (
            context.flags
            and "authorized_groups" in context.flags
            and context.flags.authorized_groups != ""
        )
    ...
    def _examples_from_path_handler(self, request):
        ...
        try:
            ...
            return http_util.Respond(
                request, {"error": e.message}, "application/json", code=400
            )
    ...
    def _infer(self, request):
        ...
        try:
            ...
            return http_util.Respond(
                request, {"error": e.details}, "application/json", code=400
            )
