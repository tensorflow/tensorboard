  ...
  <script>
    Polymer({
      ...
      properties: {
        ...
        // Data change listener. Callback will be invoked with one
        // argument: an object mapping `run` to a list of PR curve data
        // as returned by the `/pr_curves` route.
      ...
      observers: [
        ...
        '_notifyDataChange(_runToDataOverTime)',
      ],
      ...
      _notifyDataChange(runToDataOverTime) {
