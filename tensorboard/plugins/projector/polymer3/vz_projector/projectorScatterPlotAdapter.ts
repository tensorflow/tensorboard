...
const LABEL_SCALE_DEFAULT = 1;
const LABEL_SCALE_LARGE = 2;
const LABEL_FILL_COLOR_SELECTED = 0;
const LABEL_FILL_COLOR_HOVER = 0;
const LABEL_FILL_COLOR_NEIGHBOR = 0;
const LABEL_STROKE_COLOR_SELECTED = 16777215;
const LABEL_STROKE_COLOR_HOVER = 16777215;
const LABEL_STROKE_COLOR_NEIGHBOR = 16777215;
const POINT_COLOR_UNSELECTED = 14935011;
const POINT_COLOR_NO_SELECTION = 7697881;
const POINT_COLOR_SELECTED = 16410214;
const POINT_COLOR_HOVER = 7736143;
const POINT_SCALE_DEFAULT = 1;
const POINT_SCALE_SELECTED = 1.2;
const POINT_SCALE_NEIGHBOR = 1.2;
const POINT_SCALE_HOVER = 1.2;
const LABELS_3D_COLOR_UNSELECTED = 16777215;
const LABELS_3D_COLOR_NO_SELECTION = 16777215;
const SPRITE_IMAGE_COLOR_UNSELECTED = 16777215;
const SPRITE_IMAGE_COLOR_NO_SELECTION = 16777215;
