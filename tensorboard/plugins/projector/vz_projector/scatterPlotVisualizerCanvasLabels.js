...
(function (vz_projector) {
     ...
     */
    class ScatterPlotVisualizerCanvasLabels {
        ...
        makeLabels(rc) {
            ...
            const lrc = rc.labels;
            const sceneIs3D = (rc.cameraType === vz_projector.CameraType.Perspective);
            ...
            for (let i = 0; i < n; ++i) {
                ...
                let [x, y] = vz_projector.util.vector3DToScreenCoords(rc.camera, rc.screenWidth, rc.screenHeight, point);
                x += xShift;
