...
(function (vz_projector) {
     ...
     */
    class ProjectorScatterPlotAdapter {
        constructor(scatterPlotContainer, projectorEventContext) {
            ...
            this.scatterPlot = new vz_projector.ScatterPlot(scatterPlotContainer, projectorEventContext);
        ...
        updateScatterPlotAttributes() {
            ...
            const pointColors = this.generatePointColorArray(dataSet, pointColorer, this.distanceMetric, selectedSet, neighbors, hoverIndex, this.renderLabelsIn3D, this.getSpriteImageMode());
            const pointScaleFactors = this.generatePointScaleFactorArray(dataSet, selectedSet, neighbors, hoverIndex);
        ...
        generateVisibleLabelRenderParams(ds, selectedPointIndices, neighborsOfFirstPoint, hoverPointIndex) {
            ...
            const n = selectedPointCount + neighborCount + (hoverPointIndex != null ? 1 : 0);
        ...
        generatePointScaleFactorArray(ds, selectedPointIndices, neighborsOfFirstPoint, hoverPointIndex) {
            if (ds == null) {
        ...
        generatePointColorArray(ds, legendPointColorer, distFunc, selectedPointIndices, neighborsOfFirstPoint, hoverPointIndex, label3dMode, spriteImageMode) {
            if (ds == null) {
                return new Float32Array(0);
            }
            const selectedPointCount = selectedPointIndices == null ? 0 : selectedPointIndices.length;
        ...
        createVisualizers(inLabels3DMode) {
            const ds = this.projection == null ? null : this.projection.dataSet;
            ...
            if (inLabels3DMode) {
                ...
                this.canvasLabelsVisualizer = new vz_projector.ScatterPlotVisualizerCanvasLabels(this.scatterPlotContainer);
            }
