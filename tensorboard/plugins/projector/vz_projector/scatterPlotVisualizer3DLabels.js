...
(function (vz_projector) {
     ...
     */
    class ScatterPlotVisualizer3DLabels {
        createGlyphTexture() {
            ...
            const tex = vz_projector.util.createTexture(canvas);
        ...
        createLabels() {
            ...
            for (let i = 0; i < pointCount; i++) {
                const p = vz_projector.util.vector3FromPackedArray(this.worldSpacePointPositions, i);
                this.labelVertexMap[i].forEach((j) => {
