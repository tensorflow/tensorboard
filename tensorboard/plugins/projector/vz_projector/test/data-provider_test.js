    ...
    (function (test) {
        ...
        describe('parse tensors', () => {
            it('parseTensors', (doneFn) => {
                ...
                stringToArrayBuffer(dataToTsv(tensors)).then((tensorsArrayBuffer) => {
                    vz_projector.parseTensors(tensorsArrayBuffer).then((data) => {
            ...
            it('parseMetadata', (doneFn) => {
                ...
                stringToArrayBuffer(dataToTsv(metadata)).then((metadataArrayBuffer) => {
                    vz_projector.parseMetadata(metadataArrayBuffer).then((spriteAndMetadataInfo) => {
