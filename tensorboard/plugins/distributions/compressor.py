...
def CompressHistogram(histo, bps=NORMAL_HISTOGRAM_BPS):
    ...
    weight at a constant number of compression points. This significantly
    reduces
    ...
    Args:
        ...
        bps: Compression points represented in basis points, 1/100ths of a
            percent. Defaults to normal distribution.
