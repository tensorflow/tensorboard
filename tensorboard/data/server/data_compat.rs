            ...
            EventValue::Summary(SummaryValue(value_box)) => match *value_box {
                    ...
                    if tp.dtype == i32::from(pb::DataType::DtString) =>
                {
                    ...
                    if shape.dim.len() == 1 {
                        ...
                        && shape.dim[1].size == 2
                        && is_plugin(&metadata, plugins::AUDIO)
                    {
                        ...
                        && tp.string_val.len() == 1
                        && (is_plugin(&metadata, plugins::GRAPH_RUN_METADATA)
                            || is_plugin(&metadata, plugins::GRAPH_RUN_METADATA_WITH_GRAPH)
                            || is_plugin(&metadata, plugins::GRAPH_KERAS_MODEL))
                    {
...
impl GraphDefValue {
    ...
    pub fn initial_metadata() -> Box<pb::SummaryMetadata> {
        blank(plugins::GRAPHS, pb::DataClass::BlobSequence)
    }
}
...
impl TaggedRunMetadataValue {
    ...
    pub fn initial_metadata() -> Box<pb::SummaryMetadata> {
        blank(
            plugins::GRAPH_TAGGED_RUN_METADATA,
...
<<<<<<< HEAD
                    ...
                    | Some(plugins::GRAPH_RUN_METADATA_WITH_GRAPH)
...
mod tests {
        ...
        fn test_metadata_tf1x_simple_value() {
            ...
            assert_eq!(
                *result,
                pb::SummaryMetadata {
                    plugin_data: Some(PluginData {
                        plugin_name: plugins::SCALARS.to_string(),
                        ..Default::default()
                    }),
    ...
    mod blob_sequences {
        ...
        fn test_metadata_graph() {
            ...
            assert_eq!(&md.plugin_data.unwrap().plugin_name, plugins::GRAPHS);
...
<<<<<<< HEAD
        ...
        fn test_metadata_tf1x_image() {
            ...
            assert_eq!(
                *result,
                pb::SummaryMetadata {
                    plugin_data: Some(PluginData {
                        plugin_name: plugins::IMAGES.to_string(),
                        ..Default::default()
                    }),
        ...
        fn test_metadata_tf1x_audio() {
            ...
            assert_eq!(
                *result,
                pb::SummaryMetadata {
                    plugin_data: Some(PluginData {
                        plugin_name: plugins::AUDIO.to_string(),
                        ..Default::default()
                    }),
                    data_class: pb::DataClass::BlobSequence.into(),
                    ..Default::default()
        ...
        fn test_graph_subplugins() {
            for &plugin_name in &[
                plugins::GRAPH_RUN_METADATA,
                plugins::GRAPH_RUN_METADATA_WITH_GRAPH,
                plugins::GRAPH_KERAS_MODEL,
            ] {
                let md = pb::SummaryMetadata {
                    plugin_data: Some(PluginData {
                        plugin_name: plugin_name.to_string(),
...
<<<<<<< HEAD
        ...
        fn test_enrich_audio_without_labels() {
            ...
            assert_eq!(
                v.into_blob_sequence(&blank(plugins::AUDIO, pb::DataClass::BlobSequence)),
                Ok(expected)
            );
        }
