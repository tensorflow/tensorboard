...
class MigrateValueTest(tf.test.TestCase):
  ...
  def test_scalar(self):
    ...
    data = tensor_manip.make_ndarray(new_value.tensor)
  ...
  def test_image(self):
    ...
    self.assertEqual(expected_metadata, new_value.metadata)
    self.assertTrue(new_value.HasField('tensor'))
    (width, height, data) = tensor_manip.make_ndarray(new_value.tensor)
  ...
  def test_histogram(self):
    ...
    self.assertEqual(expected_metadata, new_value.metadata)
    self.assertTrue(new_value.HasField('tensor'))
    buckets = tensor_manip.make_ndarray(new_value.tensor)
