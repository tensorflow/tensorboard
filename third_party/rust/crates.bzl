...
def raze_fetch_remote_crates():
    ...
    maybe(
        ...
        build_file = Label("//third_party/rust/remote:cfg-if-0.1.10.BUILD.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//third_party/rust/remote:getrandom-0.1.15.BUILD.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//third_party/rust/remote:libc-0.2.80.BUILD.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//third_party/rust/remote:ppv-lite86-0.2.10.BUILD.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//third_party/rust/remote:rand-0.7.3.BUILD.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//third_party/rust/remote:rand_chacha-0.2.2.BUILD.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//third_party/rust/remote:rand_core-0.5.1.BUILD.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//third_party/rust/remote:rand_hc-0.2.0.BUILD.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//third_party/rust/remote:wasi-0.9.0+wasi-snapshot-preview1.BUILD.bazel"),
    )
