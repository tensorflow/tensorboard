...
will keep per tag by using the `--samples_per_plugin` command line argument (ex: `--samples_per_plugin images=100`). Alternatively you can change the source code in
